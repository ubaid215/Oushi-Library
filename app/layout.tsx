        ...
        <Toaster
          ...
          toastOptions={{
            ...
            style: {
              ...
              borderRadius: "10px",
              padding: "12px 16px",
              boxShadow: "0 8px 32px rgba(0,0,0,0.5), 0 0 0 1px rgba(196,157,84,0.2)",
              maxWidth: "380px",
              border: "1px solid rgba(196,157,84,0.15)",
            },
            success: { iconTheme: { primary: "#6a8f6a", secondary: "white" } },
            error:   { iconTheme: { primary: "#c4594a", secondary: "white" } },
          }}
        />
      </body>
    </html>
